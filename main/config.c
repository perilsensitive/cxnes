...
/* Controller Input Bindings */
	{ .name = "Joystick 0 Right Trigger +", .value = "MICROPHONE" },
	...
	{ .name = "Keyboard Left Shift", .value = "CONTROLLER_1_SELECT" },
	{ .name = "Keyboard z", .value = "CONTROLLER_1_B" },
	{ .name = "Keyboard x", .value = "CONTROLLER_1_A" },
	{ .name = "Keyboard q", .value = "CONTROLLER_1_B_TURBO_TOGGLE" },
	{ .name = "Keyboard w", .value = "CONTROLLER_1_A_TURBO_TOGGLE" },
	...
	{ .name = "Joystick 0 Y", .value = "CONTROLLER_1_B_TURBO_TOGGLE" },
	{ .name = "Joystick 0 B", .value = "CONTROLLER_1_A_TURBO_TOGGLE" },
	...
	{ .name = "Joystick 1 Y", .value = "CONTROLLER_2_B_TURBO_TOGGLE" },
	{ .name = "Joystick 1 B", .value = "CONTROLLER_2_A_TURBO_TOGGLE" },
	...
	{ .name = "Joystick 2 Y", .value = "CONTROLLER_3_B_TURBO_TOGGLE" },
	{ .name = "Joystick 2 B", .value = "CONTROLLER_3_A_TURBO_TOGGLE" },
	...
	{ .name = "Joystick 3 Y", .value = "CONTROLLER_4_B_TURBO_TOGGLE" },
	{ .name = "Joystick 3 B", .value = "CONTROLLER_4_A_TURBO_TOGGLE" },
...
/* Mat (Power Pad, Family Trainer) Input Bindings */
	...
	{ .name = "Joystick 0 Right X", .value = "ARKANOID_2_DIAL" },
	{ .name = "Joystick 0 Right Shoulder", .value = "ARKANOID_2" },
	{ .name = "Joystick 1 Right X", .value = "ARKANOID_1_DIAL" },
	{ .name = "Joystick 1 Right Shoulder", .value = "ARKANOID_1" },
	{ .name = "Mouse",
