...
/* Controller Input Bindings */
	...
	{ .name = "Keyboard z", .value = "CONTROLLER_1_SELECT" },
	{ .name = "Keyboard x", .value = "CONTROLLER_1_B" },
	{ .name = "Keyboard c", .value = "CONTROLLER_1_A" },
	{ .name = "Keyboard s", .value = "CONTROLLER_1_B_TURBO_TOGGLE" },
	{ .name = "Keyboard d", .value = "CONTROLLER_1_A_TURBO_TOGGLE" },
