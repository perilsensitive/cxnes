...
struct emu_action_id_map emu_action_id_map[] = {
	...
	EMU_ACTION_ID_MAP(CONTROLLER_1_A, CONTROLLER1, "A"),
	EMU_ACTION_ID_MAP(CONTROLLER_1_B, CONTROLLER1, "B"),
	...
	EMU_ACTION_ID_MAP(CONTROLLER_1_A_TURBO, CONTROLLER1, "A Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_1_A_TURBO_TOGGLE, CONTROLLER1, "A Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_1_B_TURBO, CONTROLLER1, "B Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_1_B_TURBO_TOGGLE, CONTROLLER1, "B Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_2_A, CONTROLLER2, "A"),
	EMU_ACTION_ID_MAP(CONTROLLER_2_B, CONTROLLER2, "B"),
	...
	EMU_ACTION_ID_MAP(CONTROLLER_2_A_TURBO, CONTROLLER2, "A Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_2_A_TURBO_TOGGLE, CONTROLLER2, "A Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_2_B_TURBO, CONTROLLER2, "B Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_2_B_TURBO_TOGGLE, CONTROLLER2, "B Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_3_A, CONTROLLER3, "A"),
	EMU_ACTION_ID_MAP(CONTROLLER_3_B, CONTROLLER3, "B"),
	...
	EMU_ACTION_ID_MAP(CONTROLLER_3_A_TURBO, CONTROLLER3, "A Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_3_A_TURBO_TOGGLE, CONTROLLER3, "A Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_3_B_TURBO, CONTROLLER3, "B Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_3_B_TURBO_TOGGLE, CONTROLLER3, "B Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_4_A, CONTROLLER4, "A"),
	EMU_ACTION_ID_MAP(CONTROLLER_4_B, CONTROLLER4, "B"),
	...
	EMU_ACTION_ID_MAP(CONTROLLER_4_A_TURBO, CONTROLLER4, "A Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_4_A_TURBO_TOGGLE, CONTROLLER4, "A Turbo Toggle"),
	EMU_ACTION_ID_MAP(CONTROLLER_4_B_TURBO, CONTROLLER4, "B Turbo"),
	EMU_ACTION_ID_MAP(CONTROLLER_4_B_TURBO_TOGGLE, CONTROLLER4, "B Turbo Toggle"),
	...
	EMU_ACTION_ID_MAP(KEYBOARD_TILDE, KEYBOARD, "~"),
	...
	EMU_ACTION_ID_MAP(KEYBOARD_ALT, KEYBOARD, "Alt"),
