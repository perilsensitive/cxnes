...
static CPU_WRITE_HANDLER(txc_22211a_write_handler);
static CPU_READ_HANDLER(txc_22211a_read_handler);
...
static struct board_write_handler unl_22211a_write_handlers[] = {
	{txc_22211a_write_handler, 0x4100, 4, 0},
	{txc_22211a_write_handler, 0x8000, SIZE_32K, 0},
	{NULL},
};
...
static struct board_read_handler unl_22211a_read_handlers[] = {
	{txc_22211a_read_handler, 0x4100, 1, 0},
	{NULL},
};

struct board_info board_unl_txc_22211a = {
	.board_type = BOARD_TYPE_UNL_TXC_22211A,
	.name = "UNL-22211-A",
	.init_prg = unl_22211a_init_prg,
	.init_chr0 = std_chr_8k,
	.write_handlers = unl_22211a_write_handlers,
	.read_handlers = unl_22211a_read_handlers,
...
static CPU_WRITE_HANDLER(txc_22211a_write_handler)
{
	...
	case 0x4103:
		...
		break;
	case 0x8000:
		update_chr0_bank(board, 0, _regs[2]);
